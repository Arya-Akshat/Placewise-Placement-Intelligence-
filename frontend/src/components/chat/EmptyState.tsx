...
export const EmptyState: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-3xl mx-auto py-12 px-4 text-center">
      ...
      <h2 className="text-2xl font-bold text-slate-100 tracking-tight">Placewise Placement Intelligence</h2>
        ...
        {prompts.map((item, idx) => {
          ...
          return (
            <button
              ...
              className="p-3.5 rounded-xl bg-slate-900/80 hover:bg-slate-800/80 border border-slate-800 hover:border-emerald-500/40 transition group shadow-sm flex flex-col justify-between text-left"
            >
              ...
              <span className="text-[11px] text-slate-500 mt-1">{item.subtext}</span>
            </button>
          );
        })}
      </div>
